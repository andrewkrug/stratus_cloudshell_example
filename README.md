...
```bash
curl -fsSL https://raw.githubusercontent.com/your-repo/stratus-cloudshell-setup/main/setup-stratus.sh | bash
```

Or clone and run manually:

```bash
git clone https://github.com/your-repo/stratus-cloudshell-setup.git
